			...
			<div id="content">
				...
				<div class="box">
					...
					<div class="vidoes">
                      			<!-- Add Videos -->
                      			<br/>
					<form action="permitcheck_manage.php?action=check" method="post">
					   ...
					   <tr>
						...
						<tr>
							<td align="right"><input class='field'  style="background-color:#F9EBAE" type="submit" name="add" value="验证"/></td>
						</tr>
